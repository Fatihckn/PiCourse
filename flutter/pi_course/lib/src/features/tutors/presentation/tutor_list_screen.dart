...
import '../../tutors/data/my_tutor_profile_provider.dart';
...
class _TutorListScreenState extends ConsumerState<TutorListScreen> {
  ...
  void initState() {
    ...
    _searchController.addListener(() {
      ref.read(_debouncedSearchProvider.notifier).state = _searchController.text;
    });
  }
  ...
  // Profil güncelleme sonrası listeyi yenilemek için
  void _refreshTutorsList() {
    setState(() {});
  }
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            // Öğretmen profil düzenleme butonu (sadece öğretmenler için)
                            Consumer(
                                  ...
                                  return Container(
                                    ...
                                    child: IconButton(
                                      onPressed: () async {
                                        ...
                                        await context.push('/tutor-profile-edit');
                            ...
                            if (ref.watch(currentUserNotifierProvider)?.role == UserRole.tutor) 
...
class _TutorsList extends ConsumerWidget {
  ...
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    // Profil güncelleme sonrası yenileme için myTutorProfileProvider'ı dinle
    ref.watch(myTutorProfileProvider);
